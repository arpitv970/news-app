...
const NewsItem = (props) => {
        ...
        return (
            <div className="my-3">
                <div className="card" style={{width: "18rem", borderColor: props.mode==='dark'?'white':'#101112', color: props.mode === "dark" ? "white" : "#101112",}}>
                <span className={`position-absolute top-0 translate-middle badge rounded-pill bg-primary`} style={{left:'50%', zIndex: '1'}}>{source}</span>
                    ...
                    <div className="card-body" style={{backgroundColor: props.mode==='dark'?'#101112':'white', color: props.mode === "dark" ? "white" : "#101112",}}>
